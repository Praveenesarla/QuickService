...
const SignupScreen = () => {
    ...
    return (
        <ImageBackground source={require('../assets/login.png')} resizeMode="cover" style={styles.container}>
            ...
            {/* Signup Button */}
            <TouchableOpacity style={styles.signupButton} onPress={confirm ? confirmCode : handleSignup}>
                <Text style={styles.buttonText}>{confirm ? 'Verify OTP' : 'Create Profile'}</Text>
            </TouchableOpacity>
