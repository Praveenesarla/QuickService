    ...
    services: [
      {
        ...
        image: require('../../assets/CarServices/insurance.png'),
      },
      {
        id: '2',
        name: 'Sell your car',
        image: require('../../assets/CarServices/sellCar.png'),
      },
      {
        id: '3',
        name: 'Car Service Report',
        image: require('../../assets/CarServices/carServiceReport.png'),
      },
      {
        id: '4',
        name: 'Buy New Car',
        image: require('../../assets/CarServices/buyNewCar.png'),
      },
      {
        id: '5',
        name: 'Cash on Car',
        image: require('../../assets/CarServices/cashOnCar.png'),
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        image: require('../../assets/CarServices/perodicServices.png'),
      },
      {
        id: '2',
        name: 'Tyre and Wheel Care',
        image: require('../../assets/CarServices/tyreWheelCare.png'),
      },
      {
        id: '3',
        name: 'Dent and Painting',
        image: require('../../assets/CarServices/dentPainting.png'),
      },
      {
        id: '4',
        name: 'A/C Services',
        image: require('../../assets/CarServices/acService.png'),
      },
    ],
  },
  {
